// components/seller/CreateShopModal.tsx
'use client';
...
import { createMyShop } from '../redux/slices/sellerSlice';
...
export function CreateShopModal({ isOpen, onClose, onSuccess }: CreateShopModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={success ? undefined : closeModal} />
      <div
      ...
      >
        ...
        {success ? (
          ...
          <div className="p-12 flex flex-col items-center justify-center">
            <TechLoader text="Creating your shop..." />
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <label className="flex items-center gap-2 px-4 py-3 rounded-xl border cursor-pointer hover:bg-white/5 transition" style={{ borderColor: border }}>
            ...
            {/* Buttons */}
            <div className="flex gap-4 pt-3 border-t" style={{ borderColor: border }}>
              <button
                type="button"
                onClick={closeModal}
              ...
              >
                {mutationLoading ? 'Creating...' : 'Create Shop'}
              </button>
            </div>
          </form>
        )}
